...
from ..monitors.pixel.pixel import PixelMonitor
...
class _FakeWCS:
    ...
    just enough for testing PixelMonitor without a real WCS.
    """
...
def _build_fake_l2_tree(nx=4088, ny=4088, plate_scale_arcsec=0.11, seed=0):
    """
    Build a fake Roman L2 ASDF file with enough structure for PixelMonitor to run.
