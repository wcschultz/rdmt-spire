...
- **Related Issues/PRs:** 
  - [PR 12](https://github.com/spacetelescope/rdmt-spire/pull/12) - Initial implementation
  - [PR 22](https://github.com/spacetelescope/rdmt-spire/pull/22) - Catalog matching improvement
...
- **Related Issues/PRs:**
  - [ISSUE 31](https://github.com/spacetelescope/rdmt-spire/issues/31) - Requirements and design
  - [PR 35](https://github.com/spacetelescope/rdmt-spire/pull/35) - Initial implementation
...
#### Joint Encircled-energy, FWHM, and SNR Monitor
- **Related Issues:**
  - Not yet made
...
- **Description:** Using the L4 detector catalog files, this monitor would bin the sources by brightness (taking a maximum number of sources per bin to keep the runtime manageable) and then estimate the typical encircled energy at several pixel radii, 2-axis FWHM, and SNR for sources in each bin. 
...
- **Estimated Work:** S 
- **Description:** WFI Flat L2s will have the RCS illumination level in the metadata. This monitor would compare the illumination values to the brightness seen in the images. **This could technically be outside the scope of Spire and might be better suited for Reef**.
...
- **Priority Level:** P2 - Medium priority
- **Estimated Work:** S
- **Description:** This is a large catch-all monitor for any types of pixel statistics that would be helpful to trend. This currently includes, but is not limited to the number of saturated pixels, min/mean/max/std/percentiles of the pixel values, and includes these values over the entire detector as well as some regions (e.g. 4 corners and a central region). Details are still TBD.
...
#### Quality of Ramp Fit Monitor
- **Estimated Work:** S
- **Description:** Monitor the quality of fit and/or chi^2 from ramp fitting. If the chi^2 values are saved in the L2 files, this could be as simple as monitoring the mean/median and some moments of that array.
